...
export default function DesignSystemGuide() {
  ...
  return (
    <div className='container mx-auto p-8 my-10 space-y-10'>
      <Typography
        as='h1'
        variant='display-lg/semibold'
        className='max-w-xl capitalize mb-40'
      >
        Design System Guide
      </Typography>
        ...
        <section className='space-y-6'>
          ...
          <div className='space-y-5'>
            <div className='flex justify-evenly'>
              <div className='w-20 h-20 rounded border-2 border-border flex items-center justify-center'>
                base
              </div>
              <div className='w-20 h-20 rounded-sm border-2 border-border flex items-center justify-center'>
                sm
              </div>
              <div className='w-20 h-20 rounded-md border-2 border-border flex items-center justify-center'>
                md
              </div>
              <div className='w-20 h-20 rounded-lg border-2 border-border flex items-center justify-center'>
                lg
              </div>
              <div className='w-20 h-20 rounded-xl border-2 border-border flex items-center justify-center'>
                xl
              </div>
            </div>
          </div>
...
`}
          ...
          <div className='flex justify-evenly'>
            ...
            <div className='w-20 h-20 rounded border-2 border-border-light flex items-center justify-center'>
              light
            </div>
            <div className='w-20 h-20 rounded border-2 border-border-lighter flex items-center justify-center'>
              lighter
            </div>
          </div>
...
--color-border-lighter-hover: var(--color-gray-100);`}
        ...
        <section className='space-y-6'>
          ...
          <div className='flex justify-evenly'>
            <div className='bg-layer w-20 h-20 rounded shadow-sm flex items-center justify-center'></div>
            <div className='bg-layer w-20 h-20 rounded shadow-md flex items-center justify-center'></div>
            <div className='bg-layer w-20 h-20 rounded shadow-lg flex items-center justify-center'></div>
            <div className='bg-layer w-20 h-20 rounded shadow-xl flex items-center justify-center'></div>
            <div className='bg-layer w-20 h-20 rounded shadow-2xl flex items-center justify-center'></div>
            <div className='bg-layer w-20 h-20 rounded shadow-inner flex items-center justify-center'></div>
          </div>
          <pre>
            <code>
...
--shadow-none: none;`}
        ...
        <section className='space-y-6'>
          ...
          <div className='flex justify-evenly'>
            <div className='w-20 h-20 rounded bg-layer flex items-center justify-center'>
              1
            </div>
            <div className='w-20 h-20 rounded bg-layer-2 flex items-center justify-center'>
              2
            </div>
            <div className='w-20 h-20 rounded bg-layer-3 flex items-center justify-center'>
              3
            </div>
            <div className='w-20 h-20 rounded bg-layer-4 flex items-center justify-center'>
              4
            </div>
          </div>
          <pre>
...
`}</code>
        ...
        <section className='space-y-6'>
          ...
          <div className='h-80 flex rounded overflow-hidden'>
            {[
              '50',
              '100',
              '200',
