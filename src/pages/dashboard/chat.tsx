...
export default function ChatPage() {
  ...
  return (
    <>
      ...
      <Layout pageTitle='Chat' className='lg:px-0 lg:py-0'>
        <div className='w-full flex flex-col md:flex-row h-[90svh] divide-x border-t border-border divide-border'>
          ...
          <div className='w-full'>
            <div className='flex flex-col h-full gap-y-5'>
              ...
              <div className='flex-1 h-full px-2 md:px-6 rounded py-4'>
                <div className='flex flex-col gap-y-5 py-7'>
                  <div className='flex flex-col h-full gap-y-7'>
                    ...
                    <div className='flex justify-end gap-x-2 items-start'>
                      <div className='bg-primary text-gray-200  dark:text-gray-800 rounded-lg p-2.5 md:p-3'>
                        <Typography
                          as='p'
                          variant='sm/medium'
                          className='max-w-[15rem] md:max-w-full'
              ...
              <div className='flex md:px-6 gap-x-1'>
          ...
          {/* messages */}
          <div className='w-full hidden 2xl:flex max-w-md px-6 flex-col gap-y-7 py-4 h-full'>
